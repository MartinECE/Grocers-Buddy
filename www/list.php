...
<html>
    ...
    <body onload="loaded()">
        <div id="header">
            <ul class="menu">
                <li><a class="main-menu" href="index.php"><i class="fa fa-home"></i></a></li>
                <li><a class="main-menu" href="available.php"><i class="fa fa-calendar"></i></a></li>
                <li><a class="main-menu" href="list.php"><i class="fa fa-shopping-cart"></i> </a></li>
            ...
            <div class="table-properties" style="color:#727272;">ITEM</div>
            <div class="table-properties" style="color:#727272;">AMOUNT</div>
            <div class="table-properties" style="color:#727272;">SUBTOTAL</div>
        </div>
